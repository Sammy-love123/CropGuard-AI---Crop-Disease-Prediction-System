...
with st.sidebar:
    ...
    st.markdown("<div style='font-size:11px;opacity:0.7;text-align:center;line-height:1.9;'><b>Bowen University, Iwo</b><br>Dept. of Computer Science<br><i>Ojugbeli Ogechi Marvellous</i><br>Supervisor: Miss Busolami<br><br>⚠️ For educational purposes only.<br>Always consult an agricultural<br>expert before any treatment.</div>", unsafe_allow_html=True)
...
if model is None or class_info is None:
    st.error("⚠️ Model files not found! Place `BEST_MobileNetV2.h5` and `class_info.json` in the same folder.")
    st.stop()
else:
